...
const Info = () => (
  <InfoLayout
    title="О сервисе"
    lead="offer — площадка рекламных интеграций: заказчик публикует объявление со ставкой за 1000 просмотров, креатор берёт его в работу и снимает ролик, а выплата считается по реальным просмотрам этого ролика."
    showUpdated={false}
  >
    <section className={styles.section}>
      ...
      <ol className={styles.list}>
        ...
        <li>Креатор откликается и публикует ролик на своей площадке.</li>
        <li>
          Сервис периодически запрашивает у площадки статистику этого ролика по официальному API
          и начисляет креатору выплату по набранным просмотрам, пока не исчерпан бюджет объявления.
        </li>
      </ol>
    </section>
    ...
    <section className={styles.section}>
      ...
      <p className={styles.text}>
        Отвязать аккаунт можно в любой момент в профиле креатора: кнопка «отвязать» рядом с аккаунтом.
